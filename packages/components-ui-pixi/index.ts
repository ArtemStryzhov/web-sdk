...
import LabelBalance from './src/components/LabelBalance.svelte';
import ButtonMenu from './src/components/ButtonMenu.svelte';
...
export { messagesMap, i18nDerived, UI, UiGameName, LabelBalance, ButtonMenu };
