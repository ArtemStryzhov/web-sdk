...
const m20Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
const m15Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
const m6Static = { type: 'sprite', assetKey: 'm2_5x.png', sizeRatios: { width: 1, height: 1 } }; // Using m2_5x as fallback
const m8Static = { type: 'sprite', assetKey: 'm2_5x.png', sizeRatios: { width: 1, height: 1 } }; // Using m2_5x as fallback
const m12Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
const m25Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
const m50Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
const m100Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
const m250Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
const m500Static = { type: 'sprite', assetKey: 'm3_10x.png', sizeRatios: { width: 1, height: 1 } }; // Using m3_10x as fallback
...
export const SYMBOL_INFO_MAP = {
	...
	M_3: {
		...
		win: {
			type: 'spine',
			assetKey: 'M',
			animationName: '10x', // Using 10x animation as fallback
			sizeRatios: { width: M_SIZE, height: M_SIZE },
		},
		land: {
			type: 'spine',
			assetKey: 'M',
			animationName: '10x_land', // Using 10x animation as fallback
			sizeRatios: { width: M_SIZE, height: M_SIZE },
		},
	},
	M_4: {
	...
	M_6: {
		...
		win: {
			type: 'spine',
			assetKey: 'M',
			animationName: '5x', // Using 5x animation as fallback
			sizeRatios: { width: M_SIZE, height: M_SIZE },
		},
		land: {
			type: 'spine',
			assetKey: 'M',
			animationName: '5x_land', // Using 5x animation as fallback
			sizeRatios: { width: M_SIZE, height: M_SIZE },
		},
	},
	M_7: {
...
export const MULTIPLIER_BACKGROUND_INFO_MAP = {
	...
	M_4: backgroundLow,
	M_5: backgroundMid,
	M_6: backgroundMid,   // 6x uses mid background
	M_7: backgroundMid,
	M_8: backgroundMid,   // 8x uses mid background
	M_10: backgroundHigh,
	M_12: backgroundHigh, // 12x uses high background
	M_15: backgroundHigh, // 15x uses high background
	M_20: backgroundHigh, // 20x uses high background
	M_25: backgroundHigh, // 25x uses high background
	M_50: backgroundHigh, // 50x uses high background
	M_100: backgroundHigh, // 100x uses high background
	M_250: backgroundHigh, // 250x uses high background
	M_500: backgroundHigh, // 500x uses high background
};
